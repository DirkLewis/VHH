...
@property (retain,nonatomic)NSMutableArray *pingTimeData;
@property (retain,nonatomic)NSMutableDictionary *sentPingRequests;
...
@property (retain,nonatomic)NSMutableArray *varianceData;
...
- (void)dealloc
{
    ...
    [_pingTimeData release];
    _pingTimeData = nil;
    
    [_sentPingRequests release];
    _sentPingRequests = nil;
    
    [_varianceData release];
    _varianceData = nil;
...
- (NSDictionary*)networkIdentifiersDictionary{
    ...
    NSDictionary *temp = [[[NSDictionary alloc] initWithDictionary:dictionary]autorelease];
    [dictionary release];
    dictionary = nil;
    return temp;
}
