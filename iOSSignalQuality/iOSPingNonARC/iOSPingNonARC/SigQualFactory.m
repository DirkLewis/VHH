...
+ (PingDataAggregator*)pingTestOfHost:(NSString*)hostName delegate:(id<PingDataAggregatorDelegate>)delegate{
    PingDataAggregator *pa = [[[PingDataAggregator alloc]initWithHostName:hostName numberOfPings:50 packetSizeBytes:0 pingVarianceMilliseconds:5 pingVarianceThreshold:2]autorelease];
...
+ (PingDataAggregator*)continuousPingOfHost:(NSString*)hostName delegate:(id<PingDataAggregatorDelegate>)delegate{
    ...
    PingDataAggregator *pa = [[[PingDataAggregator alloc]initWithHostName:hostName numberOfPings:50 packetSizeBytes:0 pingVarianceMilliseconds:10 pingVarianceThreshold:5]autorelease];
