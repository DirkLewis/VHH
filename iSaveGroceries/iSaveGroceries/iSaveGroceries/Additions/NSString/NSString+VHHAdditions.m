...
#import "NSData+VHHAdditions.h"
#import <CommonCrypto/CommonDigest.h>

@implementation NSString (VHHAdditions)

+ (NSString*)replaceStringOccurance:(NSString*)string targetCharacter:(NSString*)targetCharacter replacementCharacter:(NSString*)replacementCharacter{
    
	return [string stringByReplacingOccurrencesOfString:targetCharacter withString:replacementCharacter options:NSCaseInsensitiveSearch range:NSMakeRange(0, [string length])];
}
...
- (NSString *)stringByEscapingReservedURLCharacters
{
	NSString *escapedString = (__bridge_transfer NSString *)CFURLCreateStringByAddingPercentEscapes(NULL, (__bridge_retained CFStringRef)self, NULL, (CFStringRef)@";/?:@&=+$,", kCFStringEncodingUTF8);
	return escapedString;
}

- (NSString *)stringByUnescapingReservedURLCharacters
{
	NSString *escapedString = (__bridge_transfer NSString *)CFURLCreateStringByReplacingPercentEscapesUsingEncoding( NULL,(__bridge_retained CFStringRef)self, NULL, kCFStringEncodingUTF8);
	return escapedString;
}

- (BOOL)isEqualToStringCaseInsensitive:(NSString *)aString
{
	BOOL success = [[self uppercaseString] isEqualToString:[aString uppercaseString]];
	return success;
}
