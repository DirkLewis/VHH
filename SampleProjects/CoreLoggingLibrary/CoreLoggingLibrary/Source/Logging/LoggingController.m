...
+ (CoreDataLogger*)createCoreDataLogger:(id<CoreLoggingDataManagementProtocol>)dataManager;
...
+ (void)initializeLoggerWithDataManager:(id<CoreLoggingDataManagementProtocol>)dataManager{
    ...
    //core data loggin
    CoreDataLogger *dataLogger = [LoggingController createCoreDataLogger:dataManager];
...
+ (void)initializeLogger{
    ...
    [LoggingController initializeLoggerWithDataManager:nil];
...
+ (CoreDataLogger*)createCoreDataLogger:(id<CoreLoggingDataManagementProtocol>)datManager{
    ...
    CoreDataLogger *coreDataLogger = [[CoreDataLogger alloc] initWithLogDirectory:[basePath stringByAppendingPathComponent:@"CoreDataLogger"] andlogDataManager:datManager];
